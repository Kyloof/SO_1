...
public class FCFS extends Algorithm{
    ...
    public void simulateFCFS(int currentTime, double GENERATION_CHANCE, int STARVATION_TIME){
        ...
        while (resultProcess.size()<=20000){
            if (processQueue.size()+resultProcess.size()<=20000&&GENERATION_CHANCE>=random.nextDouble()) addToQueue(ProcessGenerator.generateRandomProcess(currentTime));
